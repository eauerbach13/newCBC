# # Data Files Downloaded from Audobon.org
# 
# # Due to the format of each file, in excel, the first three rows were deleted, resulting in the following Headers:
# # Code, Name, Latitude, Longitude, No_Observed, Number_By_Party_Hours, Flags, Editor_Comments in row 1, next, 
# the spreadsheets were manipulated to include a column named "year", this was created by either deleted both "Flags"
# and "Editor Comments", or by deleting only "Flags" as "Editor Comments" is deleted in this script in lines 139 or 140


setwd("/Users/EzraAuerbach/Downloads/CBC-master-3/")
list.files()
...
nsh85 <- read.csv("nsh1985.csv", fill=TRUE, header=TRUE, stringsAsFactors = TRUE)
...
NSHData<- rbind(nsh84, nsh85, nsh86, nsh86, nsh88, nsh89, 
